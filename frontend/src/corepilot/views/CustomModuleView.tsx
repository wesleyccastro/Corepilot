...
import type { PublishedModule } from '../types';

export function CustomModuleView({ module, actions }: { module: PublishedModule; state: CorePilotState; actions: CorePilotActions }) {
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px 80px', textAlign: 'center', position: 'relative' }}>
      ...
      <div style={{ width: 52, height: 52, borderRadius: 14, background: module.color, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
        <LayersIcon />
      </div>
      <h1 style={{ fontSize: 24, fontWeight: 800, color: colors.navy, margin: '0 0 8px' }}>{module.name}</h1>
